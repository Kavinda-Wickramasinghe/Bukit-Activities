...
function PickCard({ pick, onEdit, onDelete }) {
	...
	return (
		<article className="decisionCard">
			...
			{activity && <p className="mutedLine">{display(activity.venue_name)} · {display(venueArea)} · {display(venueCategory)} · {formatDateTime(activity.activity_date, activity.start_time)}</p>}
